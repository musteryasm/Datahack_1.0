...
def get_most_likely_bought_item(input_item):
    random_list = ['Focaccia', 'Guest Love', 'Bubbling Shrimp', 'Etta Rita', 'Bucatini Cacio e Pepe', 'Spicy Meatballs',
                   'The "etta" Chopped Salad', 'Wild Mushroom', 'Cavatelli Bolognese', 'Ricotta Pillows', 'Margherita',
                   'Crispy Chicken Sandwich', 'Little Gem Salad', 'Pomodoro', 'Caesar', 'Etta Old Fashioned',
                   'Broccolini', 'Rack Roasted Oysters', 'Burrata', 'Sparrow Regular Coffee', 'Breakfast Sandwich',
                   'etta Old Fashione', 'sunset on damen', 'Green With Envy', 'Huevos Rancheros', 'Pepperoni Pizza']
